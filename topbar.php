  ...
  <div class="container-fluid mt-2 mb-2">
      ...
      <div class="col-md-2 float-left text-dark">
        <!-- <large><b><?php echo isset($_SESSION['system']['name']) ? $_SESSION['system']['name'] : '' ?></b></large> -->
         <img src="assets/uploads/logos.png" width="150px">
      </div>
       <div class="col-md-8 float-left text-dark mt-3">
     <p style="color: gray; font-size: 14px;"><b>when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged</b></p>
      </div>
